...
function buildCandyLand(game, entry) {
  ...
  // gingerbread men
  for (const [x, z] of [[-10, 4], [12, 8], [-18, 14], [20, -4], [6, 26], [-4, -56], [-46, 34], [48, 32]]) { const rig = makeGingerbread(); W.add(rig.group); game.npcs.push(new Wanderer(game, rig, { x, z, speed: r.range(0.6, 0.9), leash: 10, r: 0.4, height: 1.4, idle: [1, 3] })); }
